...
public sealed class ArchivedPostRecord
{
    public const int ExtendedMetadataSchemaVersion = 2;
    ...
    public string? MetadataRelativePath { get; set; }
    ...
    public List<ArchivedMediaRecord> Media { get; set; } = [];
}
